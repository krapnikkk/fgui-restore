package _-Gs
{
    ...
    public class TransitionInput extends GLabel
    {
        ...
        public function TransitionInput()
        {
        ...
        private function _-9w(event:Event) : void
        {
            ...
            var _loc_3:* = _loc_2.project.getVar("SelectTransitionMenu") as PopupMenu;
            if (!_loc_3)
            {
                _loc_3 = new PopupMenu("ui://Basic/PopupMenu2");
                _loc_3.visibleItemCount = 20;
                _loc_2.project.setVar("SelectTransitionMenu", _loc_3);
            }
            ...
            _loc_3.clearItems();
            _loc_3.addItem(Consts.strings.text331, this._-E).name = "";
            var _loc_5:* = _loc_4.transitions.items;
            ...
            while (_loc_7 < _loc_6)
            {
                ...
                _loc_9 = _loc_3.addItem(_loc_8.name, this._-E);
        ...
        private function _-E(event:ItemEvent) : void
        {
