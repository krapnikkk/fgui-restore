package _-Ds
{
    ...
    public class CreateFontDialog extends _-3g
    {
        private var _path:FPackageItem;
        private var _name:GLabel;

        public function CreateFontDialog(param1:IEditor)
        {
            super(param1);
        ...
        override protected function onShown() : void
        {
            ...
            this._name.text = this._path.owner.getSequenceName("Font");
        ...
        override public function _-2a() : void
        {
            ...
            try
            {
                pi = this._path.owner.createFontItem(this._name.text, this._path.id);
