package _-Ds
{
    ...
    public class CreateComboBoxDialog extends _-3g
    {
        private var _path:FPackageItem;
        private var _-5N:Controller;

        public function CreateComboBoxDialog(param1:IEditor)
        {
            super(param1);
        ...
        override protected function onShown() : void
        {
            ...
            contentPane.getChild("n3").text = this._path.owner.getSequenceName("ComboBox");
        ...
        private function _-1(event:Event) : void
        {
            ...
            try
            {
                ...
                itemImages;
                pi = new _-Cs(this._path.owner)._-9O(contentPane.getChild("n3").text, buttonImages, bgImage, itemImages, this._path.id);
